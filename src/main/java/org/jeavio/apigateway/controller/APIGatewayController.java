...
//		}
        ...
        HttpMethodService serviceBody=parseRequest(swagger,uri, method);
//        return serviceBody;
	...
	private HttpMethodService parseRequest(Swagger swaggerObject,String uri,String method) {
...
//	To get x-amazon-apigateway-integration Object from url & method
	private static GatewayIntegration getIntegrationObject(Swagger swaggerObject,String uri,String method)
	{
